namespace Mapbox.Unity.Location
{
	...
	/// </summary>
	public class FakeLocationProvider : AbstractLocationProvider
	{
        ...
        void OnFakeLocationUpdated(Unity.Location.Location location)
        {
            ...
            //map.SetCenterLatitudeLongitude(location.LatitudeLongitude);
        }
		...
		IEnumerator PollLocationRoutine()
		{
			...
			while (true)
			{
				...
				if (!_currentLocation.IsLocationServiceEnabled || paused)
				{
